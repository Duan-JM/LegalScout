...
def find_evidence_func(
    ...
    time.sleep(1)
    manual_bogo = driver.find_element(
        by=By.XPATH, value='/html/body/div[1]/div[3]/div[2]/ul/li[5]/div[2]/div[1]/div[2]')
    manual_bogo.click()

    time.sleep(1)
    manual_bogo = driver.find_element(
        by=By.XPATH, value='/html/body/div[1]/div[3]/div[2]/ul/li[5]/div[2]/div[1]/div[2]/div/ul/li[9]/a')
    manual_bogo.click()
    ...
    try:
        ...
        find_text = driver.find_element(
            by=By.XPATH, value='/html/body/div[1]/div[3]/div[3]/div[5]/div[1]/div/div/div[2]/div/div[1]/ul/table/tbody/tr[2]/td')
...
def api_v1(
    ...
    names = generate_names(input_names=require_names, output_dir=output_dir, plugin_name=PLUGIN_NAME)
    pbar = tqdm(total=len(names))
    with Pool(processes=process_num) as pool:
        for _ in pool.imap_unordered(partial(find_evidence_func, output_dir=output_dir), names):
            pbar.update(1)
